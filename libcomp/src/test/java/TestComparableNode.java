...
import org.ap.compare.lib.model.ComparableFieldResult;
import org.ap.compare.lib.model.ComparableNode;
import org.ap.compare.lib.model.ComparableNodeResult;
import org.ap.compare.lib.model.CompareResult;
...
public class TestComparableNode {
  CompareNodeService comparableNodeService = new CompareNodeService();

  @Test
  void testCompareObjectExactMatch() {
    ComparableNode currentComparableNode = null;
    {
      Map<String, Object> pk = Map.of("deptId", "10");
  ...
  void testCompareObjectDifferentValues() {
    ...
    ComparableFieldResult diff1 =
        ComparableFieldResult.builder()
            .fieldKey("location")
            .fieldResult(CompareResult.DIFFERENT)
            .thisFieldValue("new york")
            .baseFieldValue("new orleans")
            .build();
    ComparableFieldResult diff2 =
        ComparableFieldResult.builder()
            .fieldKey("deptCode")
            .fieldResult(CompareResult.DIFFERENT)
            .thisFieldValue("HR1234")
            .baseFieldValue("HR1235")
            .build();
    ComparableNodeResult expectedResults =
        ComparableNodeResult.builder()
            .node(currentComparableNode)
            .fieldResults(expectedFieldResults)
            .build();
  ...
  void testCompareObjectDifferentTypes() {
    ...
    ComparableFieldResult diff1 =
        ComparableFieldResult.builder()
            ...
            .thisFieldValue("1001")
            .baseFieldValue("1001")
            .notes("different types java.lang.Long vs java.lang.Integer")
            .build();
    ComparableNodeResult expectedResults =
        ComparableNodeResult.builder()
            .node(currentComparableNode)
  ...
  void testCompareObjectListExactMatch() {
    ...
    {
      ComparableNode currentComparableNode = null;
      Map<String, Object> pk = Map.of("deptId", "11");
      Map<String, Object> fields =
          Map.ofEntries(
    ...
    List<ComparableNodeResult> actualResultList =
        ComparableNode.compareList(currentComparableNodeList, baseComparableNodeList);
  ...
  void testCompareObjectWithCustomFieldsExactMatch() {
    ...
    List<ComparableNode> currentComparableNodeList = new ArrayList<>();
    {
      ...
      Map<String, String> customFields =
          Map.ofEntries(
              Map.entry("color", "red"), Map.entry("shape", "square"), Map.entry("animal", "cat"));
      Map<String, Object> fields =
          Map.ofEntries(
              Map.entry("deptName", "HR"),
              Map.entry("deptCode", "HR1234"),
    ...
    }
    {
      ...
      Map<String, Object> pk = Map.of("deptId", "11");
      Map<String, String> customFields =
          Map.ofEntries(Map.entry("shade", "dark"), Map.entry("sheen", "gloss"));
      Map<String, Object> fields =
          Map.ofEntries(
              Map.entry("deptName", "Marketing"),
              Map.entry("deptCode", "MR1234"),
  ...
  void testCompareObjectWithCustomFieldsDifferentValues() {
    ...
    List<ComparableNode> baseComparableNodeList = new ArrayList<>();
    {
      ...
      Map<String, String> customFields =
          Map.ofEntries(
              Map.entry("color", "blue"), Map.entry("shape", "square"), Map.entry("animal", "cat"));
      Map<String, Object> fields =
          Map.ofEntries(
              Map.entry("deptName", "HR"),
              Map.entry("deptCode", "HR1234"),
    ...
    }
    {
      ...
      Map<String, Object> pk = Map.of("deptId", "11");
      Map<String, String> customFields =
          Map.ofEntries(Map.entry("shade", "light"), Map.entry("sheen", "gloss"));
      Map<String, Object> fields =
          Map.ofEntries(
              Map.entry("deptName", "Marketing"),
              Map.entry("deptCode", "MR1234"),
  ...
  void testCompareObjectWithCustomFieldsOneMissingOneExtra() {
    ...
    }
    {
      ...
      Map<String, String> customFields =
          Map.ofEntries(
              ...
              Map.entry("sheen", "gloss"), Map.entry("texture", "smooth"));
      Map<String, Object> fields =
          Map.ofEntries(
              Map.entry("deptName", "Marketing"),
              Map.entry("deptCode", "MR1234"),
    ...
    List<ComparableNode> baseComparableNodeList = new ArrayList<>();
    {
      ...
      Map<String, String> customFields =
          Map.ofEntries(
              Map.entry("color", "red"), Map.entry("shape", "square")
  ...
  @Test
  void testConvertToComparableNode() {
    Customer customer =
        Customer.builder().customerId(10).customerName("Acme Inc").country("USA").build();
    ComparableNode comparableNode = comparableNodeService.toComparableNode(customer);
    System.out.println("got comparableNode"+comparableNode);
  }
}
